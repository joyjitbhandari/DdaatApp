...
class NotificationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val notficationList = arrayListOf<com.example.ddaatapp.model.responseDatamodel.NotificationDataModel>(
            com.example.ddaatapp.model.responseDatamodel.NotificationDataModel(
