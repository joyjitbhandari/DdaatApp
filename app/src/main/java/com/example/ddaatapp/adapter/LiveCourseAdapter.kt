...
import com.example.ddaatapp.model.responseDatamodel.LiveCourseDataModel

class LiveCourseAdapter(val liveCourseList: ArrayList<com.example.ddaatapp.model.responseDatamodel.LiveCourseDataModel>, var context: Context) :
    ...
    class ViewHolder(var binding:LiveCourseListItemBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(liveCourseDataModel: com.example.ddaatapp.model.responseDatamodel.LiveCourseDataModel, mContext:AppCompatActivity, context: Context){
